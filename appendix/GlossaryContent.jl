...
const RAW_MATH_GLOSSARY = [
    ...
    (term="ALS", category="Mathematics", definition="Alternating Least Squares updates one factor block at a time while keeping the others fixed.", tutorial="It is simple and effective, but its local least-squares systems can become poorly conditioned.", reading="Kolda & Bader (2009)", related=["Condition number", "RALS", "Swamp / swamp-like stagnation"]),
    (term="RALS", category="Mathematics", definition="Regularized ALS adds a stabilizing term to alternating updates.", tutorial="It illustrates that solver design can change behavior near difficult regions without changing the model family.", reading="TensorKitchen documentation; tensor optimization literature", related=["ALS", "Conditioning"]),
    ...
    (term="Levenberg–Marquardt / LM", category="Mathematics", definition="A damped Gauss–Newton-type method for nonlinear least-squares problems.", tutorial="It provides a curvature-aware strategy for low-rank reconstruction.", reading="Standard nonlinear least squares; TensorKitchen documentation", related=["Conditioning", "Nonconvex optimization"]),
